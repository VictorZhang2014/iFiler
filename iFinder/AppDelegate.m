...
- (BOOL)application:(UIApplication *)application openURL:(NSURL *)url sourceApplication:(NSString *)sourceApplication annotation:(id)annotation
{
    ...
    model.fileType = [ZRFileUtil isDocument:model.path];
    openFile.fileModel = model;
    openFile.hidesBottomBarWhenPushed = YES;
    [[self.window.rootViewController.childViewControllers firstObject] pushViewController:openFile animated:YES];
    return YES;
}
